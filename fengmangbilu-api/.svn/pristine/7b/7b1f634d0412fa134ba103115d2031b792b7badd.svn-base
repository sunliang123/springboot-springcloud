...
public class ApiApplication {
	...
	public class DocumentationController implements SwaggerResourcesProvider {
		...
		public List<SwaggerResource> get() {
			...
			resources.add(swaggerResource("user", "/api/v1/user/v2/api-docs"));
			resources.add(swaggerResource("oa", "/api/v1/oa/v2/api-docs"));
			resources.add(swaggerResource("support", "/api/v1/support/v2/api-docs"));
			return resources;
		}
