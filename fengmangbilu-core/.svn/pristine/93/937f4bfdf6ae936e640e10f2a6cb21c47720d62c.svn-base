...
public class DefaultExceptionHandler {
	...
	protected ResponseEntity<Object> handleException(Exception ex) {
		...
		String errorMessage = ex.getMessage() == null ? status.getReasonPhrase() : ex.getMessage();
		return handleExceptionInternal(ex, Response.error(status.value(), errorMessage), status);
	}
