...
public class ReportController {
	...
	@GetMapping("getCard")
	@ApiOperation("获取个人名片")
	@JsonFilter(target = StaffInfo.class, filter = {"name", "mobile", "position","deptName", "companyName"} ,exclude = false)
	public Response getCard(@AuthenticationPrincipal String userId) throws Exception {
